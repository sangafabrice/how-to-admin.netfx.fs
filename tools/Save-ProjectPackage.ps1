...
function ImportTypeLibrary([string] $TypeLibPath, [string] $Namespace) {
  TlbImp.exe /nologo /silent $TypeLibPath /out:"$LibDir\Interop.$Namespace.dll" /namespace:$Namespace
}
